...
build_and_push_images() {
    ...
    local DOCKERFILE_PATH=${4:-"../src/Dockerfile"}  # Parameter for Dockerfile path, default is "../src/Dockerfile"
...
build_and_push_images "bedrock-proxy-api-ecs" "$TAG" "true" "../src/Dockerfile"
